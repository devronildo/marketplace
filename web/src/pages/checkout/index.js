...
const Checkout = () => {
    ...
    const {cart, transactionFee, defaultRecipient } = useSelector(
      ...
      const getSplitRules = () => {
        const productsByShop = _.groupBy(
          cart,
          (product) => product.store_id.recipient_id
        );
        ...
        Object.keys(productsByShop).map((shop) => {
          ...
          const totalValuePerShop = products
          ...
          result.push({
            recipient_id: products[0].store_id.recipient_id,
            percentage: Math.floor(
              ((totalValuePerShop - totalFee) / total) * 100
            ),
            liable: true,
                            ...
                            <div className="row mb-3">
                                <div className="col-6">
                                    <input type="text"
                                        ...
                                        className="form-control form-control-lg" 
                                        onChange={
                                        (e) => setTransaction({...transaction, card_number: e.target.value}) 
                                       }
                                ...
                                <div className="col-6 pl-0">
                                    <input type="text"
                                        ...
                                        className="form-control form-control-lg" 
                                        onChange={
                                        (e) => setTransaction({...transaction, card_holder_name: e.target.value}) 
                                       }
